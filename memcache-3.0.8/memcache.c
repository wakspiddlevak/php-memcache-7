...
#else
	zend_string *key_str = zend_string_init("connection", sizeof("connection"), (void **)&connection);
	if (Z_TYPE_P(id) != IS_OBJECT || zend_hash_find(Z_OBJPROP_P(id), key_str) == FAILURE) {
